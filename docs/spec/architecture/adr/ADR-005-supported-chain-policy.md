...
V1 (`docs/intent/PROJECT_GOALS.md`) commits to a single-chain, single
...
- **Single target token.** A target token is identified by its Robinhood
  ...
  approval logic belongs to T070 / `docs/spec/product/ASSET_ADMISSION.md`).
